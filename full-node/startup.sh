...
#    add genesis accounts with some initial tokens
    ...
    yes "${PASSPHRASE}" | $BINARY_NAME add-genesis-account node_admin 1000000000000u"${STAKE_DENOM}"
    yes "${PASSPHRASE}" | $BINARY_NAME add-genesis-account secondary  1000000000000u"${STAKE_DENOM}"
